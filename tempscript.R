...
groupaccspath <- "ebd_users_GA_relMay-2022.csv"
load("maps.RData")


cur_date <- "2022-08-01" %>% as_date()
rel_date <- "2022-07-01" %>% as_date()
...
coveragemappath1 <- "plot1.png"
coveragemappath2 <- "plot2.png"
